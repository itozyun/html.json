...
htmljson.PHASE = {
    ...
    ENTER_ELEMENT_WITHOUT_END_TAG   : htmljson.NODE_TYPE.ELEMENT_WITHOUT_END_TAG,
    ENTER_ELEMENT_WITHOUT_START_TAG : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG,
    ...
    NN4_COND_CMT_SHOW_LOWER_FORMURA : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG +  7,
    PROCESSING_INSTRUCTION_NAME     : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG +  8,

    TAG_NAME                        : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG +  9,
    TAG_NAME_WITHOUT_END_TAG        : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 10,
    TAG_NAME_WITHOUT_START_TAG      : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 11,

    ATTRIBUTES_START                : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 12,
    ATTRIBUTE_PROPERTY              : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 13,
    ATTRIBUTE_VALUE                 : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 14,

    STYLES_START                    : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 15,
    CSS_PROPERTY                    : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 16,
    CSS_VALUE                       : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 17,
    
    IN_INSTRUCTION_ATTRIBUTE        : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 18,

    END_OF_NODE                     : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 19,
    // copy to EXPECT -->

    CLOSE_EMPTY_ELEMENT             : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 20,
    END_OF_ATTRIBUTES               : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 21,
    END_OF_STYLES                   : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 22,
    TEXT_DATA                       : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 23,
    INSTRUCTION_ATTRIBUTE_NAME      : htmljson.NODE_TYPE.ELEMENT_WITHOUT_START_TAG + 24
};
