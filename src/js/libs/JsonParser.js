...
goog.scope(
  function(){
    ...
    JsonParser = function() {
      ...
      /** @private */ this.stringBuffer = bufferAlloc(STRING_BUFFER_SIZE);
      ...
      /** @private */ this.temp_buffs = { "2": bufferAlloc(2), "3": bufferAlloc(3), "4": bufferAlloc(4) }; // for rebuilding chars split before boundary is reached
