        ...
        switch(b.nodeType) {
          case 1:
            ...
            for (N = D; a < N; ++a) {
              ...
              var B = h.name;
              var r = Q[B] ? 1 : h.value;
              "id" === B ? (l += "#" + r, --D) : "class" === B ? (O = "." + r, --D) : (B.startsWith(U) ? (h = p(r), h.args ? (r = [h.name], r.push.apply(h.args)) : r = h.name) : r === "" + +r && z(parseInt(r, 10)) && (r = +r), m[B] = r);
            }
            l += O;
            if (q && v) {
              for (; h = E(b);) {
          ...
          case 8:
            ...
            } else if (a.startsWith("[if") && 0 < a.indexOf("><!")) {
