...
x.RTC = x.RBC;
function da(a, b, c) {
  var g = a, f = y(g), e = 0, k = b(a, null, -1, e / 3), h = [-1, a, f];
      ...
      do {
        ...
        if (void 0 === l) {
          ...
          if (-Infinity !== k) {
            if (-1 >= k) {
              h[e] += k;
            } else if (1 <= k && (h[e] += k), y(l) < l.length) {
              e += 3, h[e] = -1, h[e + 1] = g = l, h[e + 2] = f = y(l);
            } else if (c && g) {
              k = c(l, g, d + f, e / 3 + 1);
              if (Infinity === k) {
                return;
...
function I(a) {
  return E(a) || G(a) ? 3 : B(a) ? E(a[0]) ? 1 : G(a[0]) ? a[0] : -1 : -1;
}
function ja(a, b, c) {
  var g = b[1];
  b = b.slice(2);
  ...
  f && B(f[0]) && f.unshift(11);
  return f;
}
function ma(a, b, c, g, f) {
  var e;
  if (B(c) && E(c[0])) {
    var k = c[0];
    c = c.slice(1);
    ...
    E(c) && ("function" === typeof a ? e = a.call(f, c) : a[c] && (e = a[c].call(f || a)));
  }
  return B(e) ? ma(a, b, e, g, f) : e;
}
function na(a, b, c) {
  a = oa(a);
  var g;
...
function y(a) {
  var b = a[0], c = G(b) ? 2 : 1;
  1 === I(a) || 17 === b ? (a = a[c], c = !B(a) && D(a) ? c + 1 : c) : c = 11 === b ? 1 : 9 === b || 13 === b || 16 === b ? 2 : Infinity;
  return c;
}
function N(a) {
