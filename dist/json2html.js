...
WBR:!0, area:!0, base:!0, basefont:!0, br:!0, bgsound:!0, col:!0, command:!0, frame:!0, hr:!0, img:!0, input:!0, isindex:!0, keygen:!0, link:!0, meta:!0, param:!0, source:!0, track:!0, embed:!0, wbr:!0}, da = {SCRIPT:!0, STYLE:!0, TEXTAREA:!0, TITLE:!0, PLAINTEXT:!0, XMP:!0, LISTING:!0, script:!0, style:!0, textarea:!0, title:!0, plaintext:!0, xmp:!0, listing:!0}, ea = {TEXTAREA:!0, TITLE:!0, textarea:!0, title:!0}, x = {CAPTION:{ARTICLE:!0, SECTION:!0, NAV:!0, ASIDE:!0, H1:!0, H2:!0, H3:!0, H4:!0, 
...
var M = null;
function O(a) {
  return a.l ? M === a ? a.D ? ha : a.G ? P : ia : M.j === a ? ja : ka : la;
}
...
J.prototype.wrap = function(a, d, b) {
  if (this.l) {
...
function Q(a, d, b) {
  ...
  for (d = d < c ? d : c; e;) {
    c = b[--e], 11 === c.m ? c.h && c.h.length && Q(a, d, c.h) : (c.remove(), f.splice(d, 0, c), c.j = a);
  }
}
var la = 0, ka = 1, ia = 2, P = 3, ha = 4, ja = 5;
function R(a, d, b) {
  var f = a, c = U(f), e = 0, g = d(a, null, -1, e / 3), k = [-1, a, c];
          ...
          if (-Infinity !== g) {
            if (-1 >= g) {
              ...
              if (1 <= g && (k[e] += g), U(n) < n.length) {
                e += 3, k[e] = -1, k[e + 1] = f = n, k[e + 2] = c = U(n);
              } else if (b && f) {
                g = b(n, f, p + c, e / 3 + 1);
                if (Infinity === g) {
                  return;
  ...
  d(function(h, l, v, r, D, t) {
    ...
    switch(V(h)) {
      ...
      case 17:
        ...
        break;
      case 1:
        m === +m && (m = h[1]), m = K(m)[0], !L && ca[m] ? z = "" : D && !L || ma[m] && (!t || "P" !== m) ? z = m : (l[++v] = "</" + (D ? m : m.toLowerCase()) + ">", z = "");
    }
    -1 !== v && a.h(l.join(""));
    0 === r && (a = null);
  });
