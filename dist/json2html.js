var q = {checked:!0, compact:!0, declare:!0, defer:!0, disabled:!0, ismap:!0, multiple:!0, nohref:!0, noresize:!0, noshade:!0, nowrap:!0, readonly:!0, selected:!0}, u = {link:!0, meta:!0, br:!0, hr:!0, img:!0, input:!0, area:!0, base:!0, col:!0, embed:!0, keygen:!0, param:!0, track:!0, wbr:!0, command:!0, basefont:!0, frame:!0, isindex:!0, bgsound:!0}, y = {html:!0, head:!0, body:!0, p:!0, dt:!0, dd:!0, li:!0, option:!0, tbody:!0, thead:!0, tfoot:!0, td:!0, th:!0, tr:!0, rb:!0, rbc:!0, rp:!0, rt:!0, 
  ...
  function d(g, t, l, h, c) {
    ...
    switch(v) {
      ...
      case 1:
        m = g[1], w = 2;
      default:
        m = U(m), t = m[1], l = m[2], m = m[0], "p" !== x || F[m] ? x = "" : f = n(), f += "<" + m, t && (f += " id=" + T(t, G, A)), l && (f += " class=" + T(l, G, A)), z || (L = z = z || E[m] ? !0 : !1), w = g[w], !I(w) && J(w) && (f += " " + B(w)), f = (g = k(g, h || D[m], c || H[m])) ? f + (">" + g) : M ? f + ">" : f + (z ? "/>" : ">"), M ? x = "" : z && !g || y[m] && !h ? x = u[m] ? "" : m : (f += "</" + m + ">", x = ""), L && (z = !1);
    }
    return f;
  }
  function k(g, t, l) {
    ...
    for (; n < g.length; ++n) {
      c = g[n], O(c) || c === +c ? h += d([3, c], null, 0, t, l) : I(c) && (c = d(c, g, n, t, l), -1 === c ? --n : h += c);
    }
    return h;
  }
  function B(g) {
...
V.gulp = function(a, e, b) {
  ...
  return require("through2")(function(d, k, B) {
    ...
    if (d.isStream()) {
      return this.emit("error", new p("json2html", "Streaming not supported")), B();
    }
    if (".json" === d.extname) {
      try {
        const C = JSON.parse(d.contents.toString(k)), A = V(C, a, e, b);
        d.extname = "." + d.stem.split(".").pop();
        d.stem = d.stem.substr(0, d.stem.length - d.extname.length);
        d.contents = Buffer.from(A);
        this.push(d);
      } catch (C) {
        this.emit("error", new p("json2html", C));
      }
    } else {
      this.push(d);
    }
