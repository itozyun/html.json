...
(function() {
  ...
  (function() {
    ...
    p = function(a, r, q, S) {
          ...
          default:
            if (t(d)) {
              ...
              if (J(z)) {
                ...
                g = "";
                for (l in z) {
                  if (f = z[l], (h = 0 === l.indexOf(L)) && (l = l.substr(L.length)), "className" === l && (l = "class"), h && (n = void 0, h = r, k = l, w = u, v(f) && t(f[0]) ? (n = f[0], f = f.slice(1), n = f.length ? h(n, f) : h(n)) : t(f) ? n = h(f) : DEFINE_HTML2JSON__DEBUG && w("Invalid InstructionAttr value! [" + k + "=" + f + "]"), f = n), K[l] || "" !== f && null != f) {
                    if (g += " " + l, !K[l]) {
      ...
      var H = !!q.quotAlways, G = !!q.useSingleQuot, L = q.instructionAttrPrefix || DEFINE_INSTRUCTION_ATTR_PREFIX, y, x = !1;
      if (v(a)) {
