...
function O(a, d, b, n, e) {
  var w = d[1], z = d.slice(2);
  a = z.length ? a(w, z) : a(w);
  void 0 !== a && null !== a && "" !== a && (M(a) || a === +a ? b ? b.splice(n, 1, a) : (d.length = 0, d.push(3, d)) : I(a) ? 11 === a[0] ? b ? (a.shift(), a.unshift(n, 1), b.splice.apply(b, a)) : (d.length = 0, d.push.apply(d, a)) : I(a[0]) ? b ? (a.unshift(n, 1), b.splice.apply(b, a)) : (d.length = 0, d.push(11), d.push.apply(d, a)) : b ? b.splice(n, 1, a) : (d.length = 0, d.push(11, a)) : e("PROCESSING_INSTRUCTION Error! [" + JSON.stringify(d) + "]"));
  return a;
}
function P(a, d, b, n) {
  if (I(b) && M(b[0])) {
    ...
    M(b) ? e = a(b) : n("Invalid InstructionAttr value! [" + d + "=" + b + "]");
  }
  return I(e) ? P(a, d, e, n) : e;
}
function Q(a) {
...
function S(a) {
  ...
  if (d < b) {
    ...
    b < d && (e = a.split("#")[1], a = a.split("#")[0], 0 < b && (n = a.split(".")[1], a = a.split(".")[0]));
  }
  return [a, e, n];
}
;function T(a, d, b, n) {
  function e(f, u, l, h, c) {
    ...
    switch(x) {
      ...
      case 13:
        m();
        M(q) ? g += "\x3c!--[" + q + "]>" : r("CONDITIONAL_COMMENT_HIDE_LOWER Error! [" + f + "]");
        g += w(f, !0, c) + "<![endif]--\x3e";
        break;
      case 14:
        m();
        M(q) ? g += "\x3c!--[" + q + "]>\x3c!--\x3e" : r("CONDITIONAL_COMMENT_SHOW_LOWER Error! [" + f + "]");
...
T.CDATA_SECTION = 4;
T.COMMENT_NODE = 8;
T.CONDITIONAL_COMMENT_HIDE_LOWER = 13;
T.CONDITIONAL_COMMENT_SHOW_LOWER = 14;
T.NETSCAPE4_CONDITIONAL_COMMENT = 15;
T.PROCESSING_INSTRUCTION = 7;
T.gulp = function(a, d, b) {
  const n = require("plugin-error");
  return require("through2").A(function(e, w, z) {
    if (e.o()) {
      return z();
    }
    if (e.v()) {
      return this.m("error", new n("json2html", "Streaming not supported")), z();
    }
    if (".json" === e.j) {
      try {
        ...
        this.m("error", new n("json2html", r));
      }
    } else {
      this.push(e);
    }
