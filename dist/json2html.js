...
var N = null;
function O(a) {
  return a.l ? N === a ? a.D ? da : a.G ? P : ea : N.j === a ? fa : ha : ia;
}
...
var ia = 0, ha = 1, ea = 2, P = 3, da = 4, fa = 5;
function R(a, c, d) {
  ...
  c(function(h, l, y, r, C, t) {
    ...
    switch(V(h)) {
      ...
      case 17:
        ...
        break;
      case 1:
        m === +m && (m = h[1]), m = K(m)[0], !L && ca[m] ? z = "" : C && !L || ja[m] && (!t || "P" !== m) ? z = m : (l[++y] = "</" + (C ? m : m.toLowerCase()) + ">", z = "");
    }
    -1 !== y && a.h(l.join(""));
    0 === r && (a = null);
  });
