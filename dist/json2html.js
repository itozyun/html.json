...
y.RTC = y.RBC;
function A(a, c, e) {
  var f = a, d = E(f), b = 0, g = c(a, null, -1, b / 3), h = [-1, a, d];
...
function N(a, c, e, f, d) {
  ...
  if (H(e) && J(e[0])) {
    ...
    J(e) && ("function" === typeof a ? b = a.call(d, e) : a[e] && (b = a[e].call(d || a)));
  }
  return H(b) ? N(a, c, b, f, d) : b;
}
function la(a, c, e) {
  a = ma(a);
  var f;
  ...
  A(a, function(f, d, b, g) {
    function h(u, m, p) {
      if (c) {
        ...
        var q = e[e.length - 1];
        U <= V(q) ? (q.v = q.v || [], q.v.push([u, m, p]), u = null) : u = new W(q, q.h && q.h.length, u, m);
        E(f) < f.length && (e[g] = u);
      } else {
        c = new W(!0, 0, u, m), e = [c];
      }
...
W.prototype.wrap = function(a, c, e) {
  if (this.l) {
...
function X(a, c, e) {
  ...
  for (c = c < d ? c : d; b;) {
    d = e[--b], 11 === d.m ? d.h && d.h.length && X(a, c, d.h) : (d.remove(), f.splice(c, 0, d), d.j = a);
  }
}
var sa = 0, ra = 1, pa = 2, U = 3, oa = 4, qa = 5;
var Y = !1, ta = !1, ua = !1;
  ...
  c(function(m, p, q, w, F, G) {
    ...
    switch(M(m)) {
      ...
      case 1:
        ...
        if (!H(m) && I(m)) {
          for (z in m) {
            if (p = m[z], (q = 0 === z.indexOf(l)) && (z = z.substr(l.length)), "className" === z && (z = "class"), q && e && (p = N(e, z, p, d, G)), !(null == p || v[z] && !1 === p || (k[++t] = " " + z, v[z] || !0 === p))) {
              if ("style" === z && I(p) && (p = na(p), !p)) {
                continue;
              }
              k[++t] = "=" + Q(p, n, D || h);
            }
    ...
    switch(M(m)) {
      ...
      case 17:
        ...
        break;
      case 1:
        k === +k && (k = m[1]), k = R(k)[0], !K && ba[k] ? u = "" : F && !K || ea[k] && (!G || "P" !== k) ? u = k : (p[++q] = "</" + (F ? k : k.toLowerCase()) + ">", u = "");
    }
    -1 !== q && a.h(p.join(""));
    0 === w && (a = null);
  });
