var q = {xml:!0, svg:!0, math:!0}, t = {AREA:!0, BASE:!0, BASEFONT:!0, BR:!0, BGSOUND:!0, COL:!0, j:!0, FRAME:!0, HR:!0, IMG:!0, INPUT:!0, ISINDEX:!0, KEYGEN:!0, LINK:!0, META:!0, PARAM:!0, SOURCE:!0, TRACK:!0, EMBED:!0, WBR:!0}, A = {checked:!0, compact:!0, declare:!0, defer:!0, disabled:!0, ismap:!0, multiple:!0, nohref:!0, noresize:!0, noshade:!0, nowrap:!0, readonly:!0, selected:!0};
var E = {HTML:!0, HEAD:!0, BODY:!0, P:!0, DT:!0, DD:!0, LI:!0, OPTION:!0, TBODY:!0, THEAD:!0, TFOOT:!0, TD:!0, TH:!0, TR:!0, RB:!0, RBC:!0, RP:!0, RT:!0, RTC:!0, OPTGROUP:!0, CAPTION:!0, COLGROUP:!0}, F = {A:!0, AUDIO:!0, DEL:!0, INS:!0, MAP:!0, NOSCRIPT:!0, VIDEO:!0}, G = {H1:!0, H2:!0, H3:!0, H4:!0, H5:!0, H6:!0, ADDRESS:!0, BLOCKQUOTE:!0, DETAILS:!0, DIV:!0, DL:!0, FIELDSET:!0, FORM:!0, HR:!0, m:!0, NOSCRIPT:!0, OL:!0, P:!0, PRE:!0, UL:!0, h:!0, l:!0, v:!0, o:!0}, H = {SCRIPT:!0, STYLE:!0, PLAINTEXT:!0, 
XMP:!0};
function I(a) {
  return !(!a || a.pop !== [].pop);
}
  ...
  function d(f, u, m, k, c) {
    ...
    switch(v) {
      ...
      case 1:
        l = f[1], w = 2;
      default:
        l = U(l), u = l[1], m = l[2], l = l[0], "P" !== y || G[l] ? y = "" : g = n(), g += "<" + l, u && (g += " id=" + T(u, B, x || z)), m && (g += " class=" + T(m, B, x || z)), x || (L = x = x || q[l] ? !0 : !1), w = f[w], !I(w) && J(w) && (g += " " + C(w)), g = (f = h(f, F[l], c || H[l])) ? g + (">" + f) : M ? g + ">" : g + (x ? " />" : ">"), M ? y = "" : x && !f || E[l] && (!k || "P" !== l) ? y = t[l] ? "" : l : (g += "</" + l + ">", y = ""), L && (x = !1);
    }
    return g;
  }
  function h(f, u, m) {
