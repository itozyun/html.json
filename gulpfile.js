                    ...
                    ClosureCompiler(
                        {
                            ...
                            // language_in       : 'ECMASCRIPT3',
                            // language_out      : 'ECMASCRIPT3',
                            output_wrapper    : isDebug ? '%output%' : '(function(require,String,Function,Infinity,Buffer){\n%output%\n})(require,String,Function,Infinity,Buffer);'
                        }
                    )
                ).pipe(
                    ClosureCompiler(
                    ...
                    ClosureCompiler(
                        {
                            ...
                            // language_in       : 'ECMASCRIPT3',
                            // language_out      : 'ECMASCRIPT3',
                            output_wrapper    : isDebug ?  '%output%' : '(function(require,String,Function,Infinity,Buffer,Date){\n%output%\n})(require,String,Function,Infinity,Buffer,Date);'
                        }
                    )
                ).pipe(
                    ClosureCompiler(
                        {
                            ...
                            formatting        : isPrettify ? 'PRETTY_PRINT' : 'SINGLE_QUOTES',
                            warning_level     : 'QUIET',
                            output_wrapper    : '/** THIS CODE IS GENERATED BY "gulp sample", DO NOT EDIT!*/\n%output%',
